...
local function loading()
	...
	TextLabel_2.TextColor3 = Color3.fromRGB(99, 225, 225)
...
S:AddToggle("à¸ˆà¸­à¸‚à¸²à¸§",false,function(vu)
_G.WhiteScren = vu
end)
...
--Auto
    ...
    Main:AddToggle("Auto Third Sea",false, function(vu)
      ...
      Main:AddSeperator("à¸¥à¸‡à¸”à¸±à¸™ à¸à¹‰à¸²à¸§à¸«à¸™à¹‰à¸²")
    
    Main:AddToggle("à¸­à¸­à¹‚à¸•à¹‰à¸¥à¸‡à¸”à¸±à¸™à¸à¹‰à¸²à¸§à¸«à¸™à¹‰à¸²",_G.AutoAdvanceDungeon,function(value)
    ...
    Main:AddSeperator("à¸”à¸²à¸šà¸šà¸´à¸à¸¡à¸±à¸¡")
    
    Main:AddToggle("à¸­à¸­à¹‚à¸•à¹‰à¸”à¸²à¸šà¸šà¸´à¸à¸¡à¸±à¸¡",_G.AutoBudySword,function(value)
        _G.AutoBudySword = value
        StopTween(_G.AutoBudySword)
    end)
    
    Main:AddToggle("à¸­à¸­à¹‚à¸•à¹‰à¸”à¸²à¸šà¸šà¸´à¸à¸¡à¸±à¸¡Hop",_G.AutoBudySwordHop,function(value)
    ...
    Main:AddSeperator("à¸•à¸µà¸šà¸­à¸ªà¸­à¸µà¸£à¸µà¸—")
    ...
    Main:AddToggle("à¸­à¸­à¹‚à¸•à¹‰à¸•à¸µà¸šà¸­à¸ªà¸­à¸µà¸£à¸µà¸—",_G.AutoElitehunter,function(value)
    ...
    Main:AddToggle("à¸­à¸­à¹‚à¸•à¹‰à¸•à¸µà¸šà¸­à¸ªà¸­à¸µà¸£à¸µà¸— à¸­à¸­à¸",_G.AutoEliteHunterHop,function(value)
        _G.AutoEliteHunterHop = value
    end)
    
    Main:AddSeperator("à¹€à¸„à¸µà¸¢à¸§")
    
    Main:AddToggle("à¸­à¸­à¹‚à¸•à¹‰à¹€à¸„à¸µà¸¢à¸§",_G.AutoFarmBossHallow,function(value)
        _G.AutoFarmBossHallow = value
        StopTween(_G.AutoFarmBossHallow)
    end)
    
    Main:AddToggle("à¸­à¸­à¹‚à¸•à¹‰à¹€à¸„à¸µà¸¢à¸§ à¸­à¸­à¸",_G.AutoFarmBossHallowHop,function(value)
    ...
    Main:AddSeperator("à¸”à¸²à¸šà¸«à¸³à¸ˆà¸´à¹‹à¸§")
    
    Main:AddToggle("à¸­à¸­à¹‚à¸•à¹‰ à¸”à¸²à¸šà¸«à¸³à¸ˆà¸´à¹‹à¸§",_G.AutoDarkDagger,function(value)
    ...
    Main:AddToggle("à¸­à¸­à¹‚à¸•à¹‰à¸”à¸²à¸šà¸«à¸³à¸ˆà¸´à¹‹à¸§ Hop",_G.AutoDarkDagger_Hop,function(value)
    ...
    Main:AddSeperator("à¹à¸à¹‰à¸§à¸«à¸‡à¸ªà¹Œ")
    
    Main:AddToggle("à¸­à¸­à¹‚à¸•à¹‰à¹à¸à¹‰à¸§à¸«à¸‡à¸ªà¹Œ",_G.AutoFarmSwanGlasses,function(value)
    ...
    Main:AddToggle("à¹à¸à¹‰à¸§à¸«à¸‡à¸ªà¹Œà¸­à¸­à¸”",_G.AutoFarmSwanGlasses_Hop,function(value)
    ...
    Main:AddSeperator("à¸à¸£à¸°à¸”à¸¹à¸")
    
    local BoneFarm = Main:AddToggle("à¸­à¸­à¹‚à¸•à¹‰ à¸Ÿà¸²à¸£à¹Œà¸¡ à¸à¸£à¸°à¸”à¸¹à¸",_G.Auto_Bone,function(value)
        _G.Auto_Bone = value
    ...
    Main:AddToggle("à¸ªà¸¸à¹ˆà¸¡à¹€à¸‹à¸­à¸£à¹Œà¹„à¸žà¸£à¸ªà¹Œà¸­à¸±à¸•à¹‚à¸™à¸¡à¸±à¸•à¸´",_G.Auto_Random_Bone,function(value)
    ...
    Main:AddSeperator("à¸«à¸²à¸‚à¸µà¹ˆà¸ªà¸±à¸‡à¹€à¸à¸•")
    ...
    Main:AddToggle("à¸­à¸­à¹‚à¸•à¹‰ à¸Ÿà¸²à¸£à¹Œà¸¡ à¸«à¸²à¸‚à¸µà¹ˆà¸ªà¸±à¸‡à¹€à¸à¸•",_G.AutoObservation,function(value)
    ...
    Main:AddToggle("à¸­à¸­à¹‚à¸•à¹‰ à¸Ÿà¸²à¸£à¹Œà¸¡ à¸«à¸²à¸‚à¸µà¹ˆà¸ªà¸±à¸‡à¹€à¸à¸• à¸­à¸­à¸",_G.AutoObservation_Hop,function(value)
    ...
    Main:AddSeperator("à¸”à¸²à¸šà¹€à¹€à¸Šà¹‡à¸‡")
    
    Main:AddToggle("à¸­à¸­à¹‚à¸•à¹‰ à¹à¸Šà¹‡à¸‡",_G.AutoSaber,function(value)
        _G.AutoSaber = value
        StopTween(_G.AutoSaber)
    end)
    
    Main:AddToggle("à¸­à¸­à¹‚à¸•à¹‰ à¹à¸Šà¹‡à¸‡ à¸­à¸­à¸",_G.AutoSaber_Hop,function(value)
    ...
    Main:AddToggle("à¸”à¸²à¸šà¹‚à¸‹à¹‚à¸¥")
    
    Main:AddToggle("à¸­à¸­à¹‚à¸•à¹‰ à¸”à¸²à¸šà¹‚à¸‹à¹‚à¸¥",_G.AutoBuyLegendarySword,function(value)
    ...
    Main:AddToggle("à¸­à¸­à¹‚à¸•à¹‰ à¸”à¸²à¸šà¹‚à¸‹à¹‚à¸¥ à¸­à¸­à¸",_G.AutoBuyLegendarySword_Hop,function(value)
    ...
    Main:AddToggle("à¸—à¸³à¸”à¸²à¸š twoà¸Šà¸µà¹‰à¸•à¸°",_G.AutoHolyTorch,function(value)
...
--State
    ...
    Dungeon:AddToggle("à¸„à¸´à¸¥à¸­à¸­à¸£à¹ˆà¸² + à¹€à¸›à¸¥à¸µà¹ˆà¸¢à¸™ à¹€à¸à¸²à¸°",_G.Auto_Dungeon,function(value)
    ...
    Dungeon:AddToggle("à¸œà¸¥à¸•à¸·à¹ˆà¸™à¹à¸šà¸š à¸­à¸­à¹‚à¸•à¹‰",_G.Auto_Awakener,function(value)
    ...
    Dungeon:AddToggle("à¸à¸±à¸™à¸—à¸µà¹ˆà¸ˆà¸°à¸¥à¸‡",_G.AutoSelectDungeon,function(value)
    ...
    Dungeon:AddToggle("à¸‹à¸·à¹‰à¸­à¸Šà¸´à¸› 1",_G.AutoBuyChip,function(value)
    ...
    Dungeon:AddButton("à¸‹à¸·à¹‰à¸­à¸Šà¸´à¸›",function()
        game:GetService("ReplicatedStorage").Remotes.CommF_:InvokeServer("RaidsNpc","Select",_G.SelectChip)
    end)
    
    Dungeon:AddToggle("à¸­à¸­à¹‚à¸•à¹‰à¹€à¸£à¸´à¹ˆà¸¡à¸”à¸±à¸™",_G.Auto_StartRaid,function(value)
    ...
    Dungeon:AddButton("à¹€à¸£à¸´à¹ˆà¸¡à¸”à¸±à¸™",function()
        if New_World then
            fireclickdetector(game:GetService("Workspace").Map.CircleIsland.RaidSummon2.Button.Main.ClickDetector)
        elseif Three_World then
            fireclickdetector(game:GetService("Workspace").Map["Boat Castle"].RaidSummon2.Button.Main.ClickDetector)
    ...
    Dungeon:AddButton("à¹€à¸›à¸¥à¸µà¹ˆà¸¢à¸™à¹€à¸à¸£à¸²à¸°",function()
        pcall(function()
            if game:GetService("Workspace")["_WorldOrigin"].Locations:FindFirstChild("Island 5") then
